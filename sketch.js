...
function draw() {
  ...
  cello.pan(sliderPan.value());
  clarinet.pan(sliderPan.value());
  drumset.pan(sliderPan.value());
  guitar.pan(sliderPan.value());
  oboe.pan(sliderPan.value());
  piano.pan(sliderPan.value());
  saxophone.pan(sliderPan.value());
  flute.pan(sliderPan.value());
  trumpet.pan(sliderPan.value());
  violin.pan(sliderPan.value());
